...
def get_model_metrics(namespace: str, repo: str, rev: str = "main") -> Dict[str, Any]:
    ...
    total_size = sum(f["size"] or 0 for f in files_info)
...
if __name__ == "__main__":
    metrics = get_model_metrics("openai-community", "gpt2")
    print(metrics)
